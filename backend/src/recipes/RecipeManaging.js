...
//                 return res.status(453).send(response.json())
//             }
...
//         requestIngredients(req.query["userid"], req.query["googlesignintoken"]).then(response =>
//             response.data
...
//                 return res.status(456).send(response.json())
//             }
//             return response.json()
//         }).then(data => {
//             res.send(data)
...
//                 return res.status(457).send(response.json())
//             }
//             return response.json()
//         }).then(data => {
//             res.send(data)
